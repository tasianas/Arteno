          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-1 relative">
                ...
                <div className="hidden lg:block absolute -top-6 -left-6 w-24 h-24 border-2 rounded-full opacity-30" style={{ borderColor: '#D7B387' }}></div>
                <div className="hidden lg:block absolute -bottom-8 -right-8 w-32 h-32 border rounded-2xl opacity-20" style={{ borderColor: '#D7B387' }}></div>
              </div>
              ...
              <div className="order-2 lg:order-2 space-y-4 lg:space-y-8">
                <div>
                  ...
                  <div className="w-16 lg:w-24 h-0.5 lg:h-1 mb-4 lg:mb-8 rounded-full" style={{ backgroundColor: '#D7B387' }}></div>
                </div>
                  ...
                  <div className="space-y-6 lg:space-y-0 lg:flex lg:items-center lg:justify-between flex flex-col items-center lg:flex-row">
                    ...
                    <div className="flex justify-center gap-12 lg:grid lg:grid-cols-2 lg:gap-12 lg:justify-start lg:max-w-none">
                      <div className="text-center lg:text-left">
                        <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-1" style={{ color: '#D7B387' }}>2024</div>
                        <div className="text-gray-400 text-xs md:text-sm lg:text-base">Founded</div>
                      </div>
                      <div className="text-center lg:text-left">
                        <div className="text-2xl md:text-3xl lg:text-4xl font-bold mb-1" style={{ color: '#D7B387' }}>100%</div>
                        <div className="text-gray-400 text-xs md:text-sm lg:text-base">Architect-Focused</div>
                      </div>
                    </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="space-y-6 text-xl text-gray-300 leading-relaxed">
              ...
              <p>
                ...
                helping architects transform their vision into extraordinary reality.
              </p>
            </div>
          </div>
        </div>
