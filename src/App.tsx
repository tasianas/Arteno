...
const App = () => {
  ...
  const [currentPage, setCurrentPage] = useState<'home' | 'products' | 'inspirations' | 'about'>('home');
  const scrollRef = useRef<HTMLDivElement>(null);
  const searchInputRef = useRef<HTMLInputElement>(null);
  const scrollBestSellers = (direction: "left" | "right") => {
  if (!bestSellersScrollerRef.current) return;
  const scrollAmount = 300; // pixels per click
  bestSellersScrollerRef.current.scrollBy({
  ...
  // Same products data as other pages
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simple demo login - in real app, you'd validate against a backend
  ...
  const bestSellers = [
    {
      ...
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/rr%20codes/RR01.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyciBjb2Rlcy9SUjAxLnBuZyIsImlhdCI6MTc1ODExNTg5OSwiZXhwIjoxNzg5NjUxODk5fQ.tqT-Rf9qhX1CdfOFbDaSVaF0QxS5Co4HI0KJOffQx1g',
    ...
    },
    {
      name: 'GLXR-B204',
      description: 'Clear Series',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/rr%20codes/RR04%20(2).png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyciBjb2Rlcy9SUjA0ICgyKS5wbmciLCJpYXQiOjE3NTgxMTU5NTgsImV4cCI6MTc4OTY1MTk1OH0._DTLdFA5xD84Zd9fmPysYpA_EhDqOac6HhhmnD-QgoU',
    ...
    },
    {
      name: 'GLXR-B212',
      description: 'Clear Series',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/rr%20codes/RR12.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyciBjb2Rlcy9SUjEyLnBuZyIsImlhdCI6MTc1ODExNjAzOSwiZXhwIjoxNzg5NjUyMDM5fQ.d602uUvloE2Dg3xEOMy8IxZgF9OxPeGLdTlKWXFHUdc',
    ...
    },
    {
      name: 'GLXR-B219',
      description: 'Clear Series',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/rr%20codes/RR19%20(3).png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyciBjb2Rlcy9SUjE5ICgzKS5wbmciLCJpYXQiOjE3NTgxMTYxOTgsImV4cCI6MTc4OTY1MjE5OH0.Hm5gBIgwbSjwOBz4n8XLLVy4sUJcdiDApcAGqgcudhg',
      features: ['Artistic patterns'],
      bestseller: true
    },
    {
      name: 'GLXR-D407',
      description: 'Color Series',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/ks%20code/KS007.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJrcyBjb2RlL0tTMDA3LnBuZyIsImlhdCI6MTc1ODExNjM2OSwiZXhwIjoxNzg5NjUyMzY5fQ.pmuMwh65Asr1p7J9JE3utg6zcr-9zYkqvFEGhZL076M',
      features: ['Wave texture'],
      bestseller: true
    },
    {
      name: 'GLXR-D402',
      description: 'Color Series',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/ks%20code/KS002.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJrcyBjb2RlL0tTMDAyLnBuZyIsImlhdCI6MTc1ODExNjQ1MCwiZXhwIjoxNzg5NjUyNDUwfQ.7JHwfcatO1AeEDN2XwxzwDnQ_iitDVuovvYn46-Pypc',
      features: ['Diamond pattern', 'Luxury finish', 'Light reflection'],
      bestseller: true
    }
  ];
  ...
  const applications = [
    {
      ...
      description: 'Create stunning partition walls that maintain openness while providing definition',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/media/1%20(122)%20(1).jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJtZWRpYS8xICgxMjIpICgxKS5qcGciLCJpYXQiOjE3NTYyMzA4MzksImV4cCI6MTc4Nzc2NjgzOX0.Jb4TnBi55ut06JigUgrVzFECOfg5xDtilhOKjUs4CbI'
    },
    {
      title: 'Bathroom Design',
      description: 'Perfect for shower enclosures and bathroom walls with privacy and style',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/media/1%20(118).jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJtZWRpYS8xICgxMTgpLmpwZyIsImlhdCI6MTc1NjIzMDk3NiwiZXhwIjoxNzg3NzY2OTc2fQ.w_O37ltOdvyvSqOYRAX9bfziorANOd8t7zh_oJhy3go'
    },
    {
      title: 'Commercial Facades',
      description: 'Impressive exterior applications for retail and office buildings',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/media/10100.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJtZWRpYS8xMDEwMC5qcGciLCJpYXQiOjE3NTYyMzA4OTMsImV4cCI6MTc4Nzc2Njg5M30.yND39vhVmgGhDZYW6zDThU47SiTuNr-S6cmzzLsNwFo'
    },
    {
      title: 'Architectural Features',
      image: 'https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/media/nampei.jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJtZWRpYS9uYW1wZWkuanBnIiwiaWF0IjoxNzU2ODA5Njk5LCJleHAiOjE3ODgzNDU2OTl9.Cic2bINGAqQZl1K32GicUbsUBb2b1L3erytHdpqi6As',
...
// ===== REPLACE your current LoginModal with this =====
const LoginModal: React.FC = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // super simple demo check: require *something* in both fields
    if (!email || !password) {
      alert("Please enter both email and password.");
      return;
    }

    // mark user as logged in and close modal
    setIsLoggedIn(true);
    setShowLoginForm(false);
  };

// Ref for Best Sellers carousel
...
const scrollBestSellers = (dir: number) => {
  ...
  const step = firstCard ? firstCard.offsetWidth + 24 : Math.round(window.innerWidth * 0.8);
    ...
    <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4">
      <div className="bg-[#0f172a] rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label htmlFor="login-email" className="block text-sm text-gray-300 mb-2">
              Email
            </label>
            <input
              ref={emailRef}
          ...
          <button
            type="submit"
            className="w-full py-3 bg-[#D7B387] text-black font-semibold rounded-lg hover:bg-[#c49f6c] transition-colors"
          >
            Sign In
          </button>
        </form>
...
/>
        ...
        <div className="p-6 text-center">
          <p className="text-gray-500 text-sm">
            {searchQuery ? 'Click on any product to view details • ' : ''}Press ESC to close or click the X button above
          </p>
        </div>
      </div>
    </div>
  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-screen bg-black">
        ...
        <nav className="fixed top-0 w-full backdrop-blur-sm border-b z-50" style={{ backgroundColor: 'rgba(0, 0, 0, 0.9)', borderColor: '#333' }}>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t bg-black border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="#about" onClick={handleAboutClick} className="block px-3 py-2 text-gray-300 hover:text-white">About</a>
              <button
                onClick={handleLogout}
          ...
          <div className="text-center">
            <div className="space-y-6 text-gray-800">
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                At ARTENO, we highlight the essence of each material as an architectural statement.
              </p>
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                Glass blocks are making a bold return — reintroduced with new textures and applications, becoming the canvas for luminous, daring compositions.
              </p>
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                We curate rare, refined materials you won't find everywhere — for projects with character and a distinct architectural signature.
              </p>
            </div>
          </div>
        </div>
...
<section id="best-sellers" className="py-20 bg-black">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-10">
      <h2 className="text-4xl lg:text-5xl font-bold text-white">Our Best Sellers</h2>
      <p className="text-gray-300 max-w-3xl mx-auto mt-4">
        Discover our most popular glass blocks, each engineered for specific applications
        and beloved by architects worldwide.
      </p>
    </div>
      ...
      >
        {bestSellers.map((item) => (
          ...
          >
            ...
            {/* Info */}
            <div className="p-4">
              <h3 className="text-white font-semibold">{item.code || item.name}</h3>
              <p className="text-gray-400 text-sm">{item.category || 'Clear Series'}</p>
              {item.feature && (
  ...
  <div className="flex justify-center py-6 bg-black">
    <div
      className="w-[220px] md:w-[800px] h-[2px]"
      style={{ backgroundColor: '#D7B387' }}
    />
  </div>
</section>
  ...
  <div className="text-center mt-2 text-xs text-gray-400 select-none">
    Swipe to see more
  </div>
      ...
      <section id="applications" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">Inspirations</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ideas start with materials.
Discover how our glass blocks can define, divide, and elevate space — one detail at a time.
            </p>
          </div>
      ...
      <div className="flex justify-center py-16 bg-black">
        <div className="w-[250px] md:w-[800px] h-0.5" style={{ backgroundColor: '#D7B387' }}></div>
      </div>
      ...
      <section id="why-choose-us" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 px-2">Why Choose Us</h2>
            <p className="text-base md:text-lg lg:text-xl text-white max-w-3xl mx-auto px-4 leading-relaxed">
             We're a new company with a clear mission: to provide rare, high-quality materials that help architects create bold, one-of-a-kind spaces.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Unique Materials</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                  We curate carefully selected materials that aren't found everywhere — ideal for projects that demand originality and distinction.
                </p>
              </div>
            </div>
            ...
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Architect-Focused</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                  We work exclusively with architectural firms, understanding their needs and providing materials that elevate their creative vision.
                </p>
              </div>
            </div>
            ...
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Fresh Energy & Flexibility</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                 As a new and agile company, we bring fresh energy, fast response times, and a flexible approach to every collaboration.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="about" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">Crafting Light Since 1985</h2>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                For over three decades, we've been at the forefront of glass block manufacturing, combining traditional craftsmanship with cutting-edge technology to create products that inspire architects and delight end users.
              </p>
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Our commitment to quality, innovation, and sustainability has made us the preferred choice for residential, commercial, and industrial projects worldwide.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <img 
                  src="https://awjcsoixmhgvatzcismt.supabase.co/storage/v1/object/sign/media%202%20products/10%20(1).jpg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8wYWNlMDFmMi04YzQ5LTQ1YjQtYWRmYi0zYjJjZjgyNmFkMmMiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJtZWRpYSAyIHByb2R1Y3RzLzEwICgxKS5qcGciLCJpYXQiOjE3NTYzMDE0NzQsImV4cCI6MTc4NzgzNzQ3NH0._PICjR1O49JL79vpjD69YvKWT7CM08DRPuaU_3LrVb4" 
...
Whether you're exploring materials, planning your next design, or just curious about what we offer — our team is here to help.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="font-semibold text-white">Visit Our Showroom</div>
                    <div className="text-gray-300">181 Grigoriou Lambraki St., Thessaloniki 543 42<br />Fotiadis – Bathroom & Tiles</div>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">69 70 56 33 27</div>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">info@arteno.com</div>
                  </div>
                </div>
              </div>
...
<div>
  ...
  >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      <div>
        <label htmlFor="firstName" className="block font-medium text-gray-300 mb-2">
          First Name
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="lastName" className="block font-medium text-gray-300 mb-2">
          Last Name
        </label>
        <input
          type="text"
    ...
    <div>
      <label htmlFor="project" className="block font-medium text-gray-300 mb-2">
        Project Type
      </label>
      <select
        id="project"
      ...
      >
        ...
        <option value="residential" className="bg-white text-black">Residential</option>
        <option value="commercial" className="bg-white text-black">Commercial</option>
        <option value="industrial" className="bg-white text-black">Industrial</option>
    ...
    <button
      type="submit"
      className="w-full text-black py-3 px-6 rounded-lg font-semibold transition-colors hover:opacity-90"
      style={{ backgroundColor: '#D7B387' }}
    >
      Send Message
    </button>
...
<footer style={{ backgroundColor: '#D7B387' }} className="py-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8 items-start text-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <ul className="space-y-2 text-gray-800 text-sm text-center">
          <li><a href="#products" onClick={handleProductsClick} className="hover:text-black transition-colors">Clear Series</a></li>
          <li><a href="#products" onClick={handleProductsClick} className="hover:text-black transition-colors">Color Series</a></li>
          <li><a href="#products" onClick={handleProductsClick} className="hover:text-black transition-colors">All Products</a></li>
          <li>
  <a
    href="#best-sellers"
    ...
    Best Sellers
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="space-y-2 text-gray-800 text-sm leading-relaxed">
          <p>Premium glass blocks for architectural excellence.</p>
          <p>Illuminating spaces with quality, innovation, and timeless design since 1985.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <ul className="space-y-2 text-gray-800 text-sm text-center">
          <li><a href="#about" onClick={handleAboutClick} className="hover:text-black transition-colors">About Us</a></li>
          <li>
  <a 
    href="#why-choose-us" 
  ...
  >
    Why Choose Us
          ...
          <li><a
  href="#inspirations" onClick={handleInspirationsClick} className="hover:text-black transition-colors"
>
  Inspirations
</a></li>
          <li><a href="#contact" className="hover:text-black transition-colors">
  Contact Us
</a>
</li>
