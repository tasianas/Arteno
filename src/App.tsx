...
import { Menu, X, ArrowLeft, ArrowRight, Building2, Lightbulb, Shield, Users, Mail, Phone, MapPin, ExternalLink, CheckCircle, ChevronLeft, ChevronRight, Search, Eye, EyeOff, Clock, CircleUser as UserCircle, LogOut, Settings } from 'lucide-react';
...
const App = () => {
  ...
  const [currentPage, setCurrentPage] = useState<'home' | 'products' | 'product-detail' | 'inspirations' | 'about' | 'admin'>('home');
  ...
  const [contactForm, setContactForm] = useState({ firstName: '', lastName: '', email: '', projectType: '', message: '' });
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="text-center mt-6">
            <p className="text-gray-300 text-sm">
              Call Us at: <span className="text-white font-semibold">210 440 85 85</span>
            </p>
          </div>
        </form>
      </div>
              ...
              <div className="mt-8">
                ...
                {filteredProducts.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm">Try searching by product code:</p>
                    <div className="flex flex-wrap justify-center gap-2 mt-2">
                      <span className="px-3 py-1 bg-gray-800 rounded-full text-gray-300 text-xs">GRLX</span>
                      <span className="px-3 py-1 bg-gray-800 rounded-full text-gray-300 text-xs">GRCL</span>
                      <span className="px-3 py-1 bg-gray-800 rounded-full text-gray-300 text-xs">GRFR</span>
                    </div>
                  </div>
                )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8 flex-1">
              ...
              {user?.type === 'admin' && (
                <a href="#admin" onClick={handleAdminClick} className="text-gray-300 hover:text-white transition-colors">Admin</a>
              )}
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t bg-black border-gray-800">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="px-3 py-3 border-b border-gray-700 mb-2">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs capitalize">{user?.type} Account</p>
                  </div>
                </div>
              </div>
              ...
              {user?.type === 'admin' && (
                <a href="#admin" onClick={handleAdminClick} className="block px-3 py-2 text-gray-300 hover:text-white">Admin</a>
              )}
              <button
                onClick={handleSearchToggle}
          ...
          <div className="text-center">
            <div className="space-y-6 text-gray-800">
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                ARTENO is more than a material source. 
                It’s a meeting point for design visionaries.
              </p>
                <p className="text-xl lg:text-2xl leading-relaxed font-light">
We work alongside architects and creators to explore how structure, light, and form can shape meaningful spaces.
              </p>
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                Discover our best-selling glass blocks. Selected by architects and designers for their performance, versatility, and timeless appeal.
              </p>
              <p className="text-xl lg:text-2xl leading-relaxed font-light">
                Projects that inspire new ways of seeing and building. Where materials become ideas, and ideas become architecture.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-lg lg:text-xl text-white max-w-3xl mx-auto px-4 leading-relaxed">
             At ARTENO, we bring a fresh vision to architectural materials, curating rare, design-driven elements that empower architects and designers to create distinctive, expressive spaces.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Sampling</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                  Experience the material before the build.
 We provide tailored samples and mock-ups to help you explore texture, light, and finish in context.
                </p>
              </div>
            </div>
            ...
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Range</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                  A curated selection of unique design materials from glass blocks to new surfaces chosen for their quality, character, and architectural integrity.
                </p>
              </div>
            </div>
            ...
            <div className="text-center text-white">
              <div className="mx-2 md:mx-0 bg-gradient-to-br from-gray-900 to-gray-1100 border-0 md:border md:border-gray-700 rounded-2xl md:rounded-2xl p-4 md:p-8 flex flex-col justify-center shadow-xl md:shadow-none">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Support</h3>
                <p className="text-sm md:text-base text-gray-300 leading-relaxed">
                 From concept to completion, our team works alongside architects and designers, offering technical insight and design guidance at every stage.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="about" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">A new chapter built on years of experience.</h2>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                ARTENO combines the insight of years of expertise with a forward-looking approach to design materials.
              </p>
      ...
      <section id="contact" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
From material selection to design consultation, our team is here to provide insight, samples, and support tailored to your needs.
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">info@artenomaterials.com</div>
                  </div>
                </div>
              </div>
    ...
    <form
      onSubmit={async (e) => {
        ...
        try {
          ...
          setContactForm({ firstName: '', lastName: '', email: '', projectType: '', message: '' });
